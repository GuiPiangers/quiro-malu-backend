...
//     // Mock para simular que já existe uma anamnese para o paciente e usuário
...
//     const data: AnamnesisDTO = {
//       patientId: "patient123",
//       description: "New anamnesis description",
//     };
//     const userId = "user456";

//     // Mock para simular que não existe anamnese para o paciente e usuário
//     mockAnamnesisRepository.get.mockResolvedValue([]);
