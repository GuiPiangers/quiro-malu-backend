...
describe("Update patient", () => {
    ...
    it("Should not be able to update a CPF patient to an existing CPF", async () => {
        ...
        await expect(updatePatientUseCase.execute(patientUpdated, 'userid')).rejects.toEqual(
    ...
    it("Should be able to update a patient", async () => {
        ...
        const updatePatient = await updatePatientUseCase.execute(patientUpdated, 'id')
