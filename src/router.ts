...
import { setUserAsClinicianController } from './core/clinician/controllers/setUserAsClinician'
...
router.get(
  ...
  authorize('users:read'),
  (request, response) =>
    listRolePermissionsController.handle(request, response),
)
router.put(
  '/roles/:id/permissions',
  authMiddleware,
  authorize('users:write'),
  (request, response) =>
    replaceRolePermissionsController.handle(request, response),
)
router.get(
  '/permissions',
  authMiddleware,
  authorize('users:read'),
  (request, response) =>
    listSystemPermissionsController.handle(request, response),
)
router.patch(
  '/users/:id/role',
  authMiddleware,
...
router.post(
  ...
  authMiddleware,
  authorize('users:write'),
  (request, response) => setUserAsClinicianController.handle(request, response),
)
router.put(
  ...
  authorize('users:write'),
  (request, response) =>
    setClinicianServicesController.handle(request, response),
)
...
router.put(
  ...
  authorize('messages:write'),
  async (request, response) => {
    return await bindMessageSendStrategyCampaignsController.handle(
      request,
      response,
    )
  },
...
router.get(
  ...
  async (request, response) => {
    return await getWhatsAppMessageLogsSummaryController.handle(
      request,
      response,
    )
  },
